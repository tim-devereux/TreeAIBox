# Contributor Covenant Code of Conduct for the TreeAIBox project

([Français](#code-de-conduite-pour-le-projet-nom-du-projet))

Contributors to repositories hosted in TreeAIBox are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the Values and Ethics Code for the Public Sector
...
# Code de conduite pour le projet TreeAIBox
<!--markdownlint-enable MD025-->

([English](#contributor-covenant-code-of-conduct-for-the-project_name-project))

Les contributeurs aux dépôts hébergés dans TreeAIBox sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le Code de valeurs et d'éthique du secteur public.
